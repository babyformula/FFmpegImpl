...
#define FFMPEG_CONFIGURATION "--enable-avcodec --enable-avformat --enable-avutil --enable-avdevice --enable-swscale --enable-swresample --enable-avresample --enable-gpl --enable-libx264 --enable-libx265 --enable-static --enable-shared --enable-debug"
