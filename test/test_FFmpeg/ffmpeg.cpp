...
void stream_video(double width, double height, int fps, int camID, int bitrate, std::string codec_profile, std::string inserver, std::string server)
{
...
int main(int argc, char *argv[])
{
    ...
    stream_video(width, height, fps, cameraID, bitrate, h264profile, inputServer, outputServer);
